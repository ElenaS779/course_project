...
public class CloseTaskTest {
    ...
    @Test
    @Description("Test: close task for the project")
    public void closeTaskToProject() throws InvocationTargetException, InstantiationException, IllegalAccessException {
        new LoginPage()
                .openLoginPage()
